...
case class HttpClientConfigMXBeanImpl(name: String,
  ...
  val uriParsingMode = cps.connectionSettings.parserSettings.uriParsingMode match {
    case Strict => "strict"
    case Relaxed => "relaxed"
  }

  val cookieParsingMode = cps.connectionSettings.parserSettings.cookieParsingMode match {
  ...
  val errorLoggingVerbosity = cps.connectionSettings.parserSettings.errorLoggingVerbosity match {
    case Off => "off"
    case Simple => "simple"
    case Full => "full"
  }
  ...
  val illegalResponseHeaderValueProcessingMode =
    cps.connectionSettings.parserSettings.illegalResponseHeaderValueProcessingMode match {
      case IllegalResponseHeaderValueProcessingMode.Error => "error"
      case Warn => "warn"
      case Ignore => "ignore"
    }
